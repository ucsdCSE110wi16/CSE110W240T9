...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set the text edit field colors
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                if (result.equals("userDoesNotExist")) {
                    ...
                    Log.e("HERE~!!!!!!", "" + list.size() + ": "+ (EventListHandler.getFinishedDynamicList() instanceof DynamicEventList));

                    byte[] bytes = Serializer.serialize(list);
                    String strForData = ByteArrayViaString.byteArrayToString(bytes);
                    ...
                    builder = new Uri.Builder().appendQueryParameter("email", mEmail)
                            ...
                            .appendQueryParameter("backup", strForData)
                    ...
                    if (result.equals("incorrectPassword")) {
                        ...
                        try {
                            ...
                            Log.e("shittt", e.getMessage());
                        }

                        ArrayList<CalendarObjectList<? extends AbstractCollection<? extends CalendarObject>, ? extends CalendarObject>> list
                                = (ArrayList<CalendarObjectList<? extends AbstractCollection<? extends CalendarObject>, ? extends CalendarObject>>) o;

                        Log.e("object created", "yes");
